  ...
  getCards() {
    ...
      'park', 'fork', 'father', 'needle', 'tea', 'libra', 'mark', 'tomato', 'video', 'family', 'month', 'coat', 'goal', 'parade', 'drop',
      'turbine', 'art', 'blood', 'south', 'star', 'emperor', 'Africa', 'potato', 'camel', 'airplane', 'float', 'plush', 'roller', 'planer',
       'velvet', 'shoe', 'lightning', 'painter', 'rider', 'minute', 'kitty', 'sanoe', 'Seattle', 'seed', 'cheek', 'premiere', 'stand',
       'west', 'climate', 'housewife', 'block', 'roast', 'duck', 'jam', 'graffiti', 'snout', 'pipe', 'rake', 'drug', 'Zurich',
